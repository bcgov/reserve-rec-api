...
exports.handler = async (event, context) => {
  logger.info("Bookings Check-In PUT:", requestIdentity(event));
  ...
  try {
    ...
    // Staff (or higher) scoped to THIS booking's collection may check it in. Previously the
    // handler only confirmed some admin identity, so an admin for one park could check in
