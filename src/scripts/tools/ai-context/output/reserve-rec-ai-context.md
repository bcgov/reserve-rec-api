...
```json
{
  ...
  "description": "The Bedwell Lake Trail area in Strathcona Park is a steep but well‑built route leading to spectacular subalpine lakes surrounded by rugged mountain peaks, offering some of the park’s best day‑hiking and backcountry camping.",
  "envelope": {
    "type": "envelope",
    "coordinates": [
      [-125.610, 49.522],
