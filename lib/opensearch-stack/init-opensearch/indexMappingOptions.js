/**
 * Index mapping options for OpenSearch indices.
 *
 * This defines the structure of the data and how it should be indexed in OpenSearch.
 *
 * The mapping options include field types for various properties such as geospatial
 * data, user information, booking details, and policies. This ensures that the data
 * is indexed in a way that supports efficient querying and retrieval based on the
...
const transDataIndexMappingOptions = {
  properties: {
    ...
    startDate: {
      type: "date",
      format:
        "yyyy-MM-dd||yyyy-MM-dd'T'HH:mm:ss'Z'||yyyy-MM-dd'T'HH:mm:ss.SSS'Z'",
    },
    endDate: {
      type: "date",
      format:
    ...
    vehicleInformation: { type: "object" },
