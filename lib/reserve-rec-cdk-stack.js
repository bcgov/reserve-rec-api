...
class ReserveRecCdkStack extends Stack {
  constructor(scope, id, props) {
    ...
    streamRole.addManagedPolicy('arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole')
    streamRole.addManagedPolicy('arn:aws:iam::aws:policy/service-role/AWSLambdaDynamoDBExecutionRole')
    streamRole.addManagedPolicy('arn:aws:iam::aws:policy/service-role/AWSLambdaVPCAccessExecutionRole')
