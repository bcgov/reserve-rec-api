...
class ReserveRecCdkStack extends Stack {
  constructor(scope, id, props) {
    ...
    props.env.WEBSOCKET_URL = webSocketApi.apiEndpoint;
    ...
    if (props.env.IS_OFFLINE !== 'true') {
      props.env.OPENSEARCH_ENDPOINT_URL = `https://${opensearchDomain.domainEndpoint}`;
    }
    ...
    const streamResources = new StreamResources(this, 'StreamResources', {
      ...
      webSocketApi: webSocketApi.arnForExecuteApi(),
      env: props.env,
      layers: [
        baseLayer,
        awsUtilsLayer,
