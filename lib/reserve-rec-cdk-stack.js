    ...
    const opensearchDomain = new opensearch.Domain(this, 'OpenSearchDomain', {
      ...
      fineGrainedAccessControl: {
        ...
        samlAuthenticationOptions: {
          idpEntityId: props.env.SAML_IDP_ENTITY_ID,
          // idpMetadataContent: props.env.SAML_IDP_METADATA_CONTENT, // TODO: Add this to the env vars - it's a big string and should be a secret but cdk deploy hates consuming this as a secret
          rolesKey: 'Role',
