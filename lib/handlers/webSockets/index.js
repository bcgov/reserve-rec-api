...
async function onConnect(event) {
  ...
  console.log(event.requestContext.connectionId, 'https://' + event.requestContext.domainName, event.requestContext.stage, { message: "Connected" });

  await sendMessage('FbGouexcYosCHIg=', 'https://' + event.requestContext.domainName, event.requestContext.stage, { message: "Connected" });
  await sendMessage('FbGtDf8P4osCFlw=', 'https://' + event.requestContext.domainName, event.requestContext.stage, { message: "Connected" });
  await sendMessage('FbGu-eQEYosCFbQ=', 'https://' + event.requestContext.domainName, event.requestContext.stage, { message: "Connected" });
