...
const BRAND_ASSETS = [
  ...
  { cid: 'icon-exclamation', file: 'icon-exclamation.png', key: 'exclamationCid'},
  { cid: 'icon-facebook', file: 'icon-facebook.png', key: 'facebookCid' },
  { cid: 'icon-instagram', file: 'icon-instagram.png', key: 'instagramCid' },
];
