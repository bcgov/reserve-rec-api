...
function geozonesSetup(scope, props) {
  ...
  // /geozones/{gzcollection}/{gzcollectionid}/{gzid} resource
  const geozonesCollectionSubAreaId = geozonesCollectionId.addResource('{gzid}');

  // GET /geozones/{gzcollection}/{gzcollectionid}/{gzid}
  ...
  geozonesCollectionSubAreaId.addMethod('GET', new apigateway.LambdaIntegration(geozonesGetByGzCollectionGeozoneId));

  // POST /geozones/{gzcollection}/{gzcollectionid}/{gzid}
  ...
  geozonesCollectionSubAreaId.addMethod('POST', new apigateway.LambdaIntegration(geozonesPostByGzCollectionGeozoneId));
  
  // PUT /geozones/{gzcollection}/{gzcollectionid}/{gzid}
  ...
  geozonesCollectionSubAreaId.addMethod('PUT', new apigateway.LambdaIntegration(geozonesPutByGzCollectionGeozoneId));
  
  // DELETE /geozones/{gzcollection}/{gzcollectionid}/{gzid}
  ...
  geozonesCollectionSubAreaId.addMethod('DELETE', new apigateway.LambdaIntegration(geozonesDeleteByGzCollectionGeozoneId));
