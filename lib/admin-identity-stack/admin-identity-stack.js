...
class AdminIdentityStack extends BaseStack {
  constructor(scope, primer) {
    ...
    this.bcscOIDCProvider = new cognito.UserPoolIdentityProviderOidc(this, this.getConstructId('bcscOIDCProvider'), {
        ...
        endpoints: {
          authorization: 'https://idtest.gov.bc.ca/login/oidc/authorize',
          token: 'https://dpda9unosgd76.cloudfront.net/api/bcsc/token/dev',
          userInfo: 'https://dpda9unosgd76.cloudfront.net/api/bcsc/userinfo/dev',
          jwksUri: 'https://dpda9unosgd76.cloudfront.net/api/bcsc/jwks'
        },
