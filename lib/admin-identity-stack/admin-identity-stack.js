...
class AdminIdentityStack extends BaseStack {
  constructor(scope, primer) {
    ...
    scope.resolveAuthenticatedCognitoRoleArn = this.resolveAuthenticatedCognitoRoleArn.bind(this);
    scope.resolveUnauthenticatedCognitoRoleArn = this.resolveUnauthenticatedCognitoRoleArn.bind(this);
  ...
  resolveAuthenticatedCognitoRoleArn(consumerScope) {
    return this.resolveReference(consumerScope, this.getExportSSMPath('cognitoAuthRoleArn'));
  }

  resolveUnauthenticatedCognitoRoleArn(consumerScope) {
