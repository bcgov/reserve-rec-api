...
class PublicIdentityStack extends BaseStack {
  constructor(scope, primer) {
    ...
    addEventMetrics(this.preSignUpFunction, metricNamespace, ['signup_refused', 'signup_phone_refused', 'signup_flagged'], eventAlarms);
    ...
    addEventMetrics(this.preTokenGenerationFunction, metricNamespace,
      ['account_created', 'account_flagged', 'email_changed', 'email_change_refused'], eventAlarms);
