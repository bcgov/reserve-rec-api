...
class PublicIdentityStack extends BaseStack {
  constructor(scope, primer) {
    ...
    this.publicUserPool = new cognito.UserPool(this, this.getConstructId('publicUserPool'), {
      ...
      customAttributes:{
        licensePlate: new cognito.StringAttribute({ minLen: 1, maxLen: 2048, mutable: true }),
        mobilePhone: new cognito.StringAttribute({ minLen: 1, maxLen: 2048, mutable: true }),
        postalCode: new cognito.StringAttribute({ minLen: 1, maxLen: 2048, mutable: true }),
        province: new cognito.StringAttribute({ minLen: 1, maxLen: 2048, mutable: true }),
        pwUpdate: new cognito.StringAttribute({ minLen: 1, maxLen: 2048, mutable: true }),
        secondaryNumber: new cognito.StringAttribute({ minLen: 1, maxLen: 2048, mutable: true }),
        streetAddress: new cognito.StringAttribute({ minLen: 1, maxLen: 2048, mutable: true }),
        vehicleRegLocale: new cognito.StringAttribute({ minLen: 1, maxLen: 2048, mutable: true }),
      },
