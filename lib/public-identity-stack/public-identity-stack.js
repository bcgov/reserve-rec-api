...
const { addEventDashboard, addEventMetrics, eventMetricNamespace } = require('../helpers/event-metrics');
...
class PublicIdentityStack extends BaseStack {
  constructor(scope, primer) {
    ...
    addEventDashboard(this, this.getConstructId('eventDashboard'), metricNamespace);
