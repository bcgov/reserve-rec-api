...
const OPENSEARCH_ENDPOINT_URL = process.env.OPENSEARCH_ENDPOINT_URL || 'http://localhost:9200';
...
let client = new Client({
  ...
  node: OPENSEARCH_ENDPOINT_URL // OpenSearch domain URL
});

// For offline development
if (process.env.IS_OFFLINE === 'true') {
  client = new Client({
    node: OPENSEARCH_ENDPOINT_URL,
    ssl: {
