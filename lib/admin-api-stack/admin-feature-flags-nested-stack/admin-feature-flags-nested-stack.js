...
/**
 * NestedStack for Admin Feature Flags API endpoints
 * 
 ...
 */
class FeatureFlagsNestedStack extends NestedStack {
  get stackId() {
  ...
  constructor(scope, id, props) {
    ...
    this.featureFlagsConstruct = new AdminFeatureFlagsConstruct(this, 'FeatureFlags', {
...
module.exports = { FeatureFlagsNestedStack };
