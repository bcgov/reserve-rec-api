...
/**
 * NestedStack for Admin Relationships API endpoints
 * 
 ...
 */
class RelationshipsNestedStack extends NestedStack {
  get stackId() {
  ...
  constructor(scope, id, props) {
    ...
    this.relationshipsConstruct = new RelationshipsConstruct(this, 'Relationships', {
...
module.exports = { RelationshipsNestedStack };
