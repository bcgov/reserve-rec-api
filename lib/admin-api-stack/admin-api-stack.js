...
const defaults = {
  ...
  constructs: {
    ...
    adminFacilitiesConstruct: {
      name: 'AdminFacilitiesConstruct',
    },
    activitiesConstruct: {
      name: 'ActivitiesConstruct',
    },
    adminProductsConstruct: {
      name: 'AdminProductsConstruct',
    },
    policiesConstruct: {
...
class AdminApiStack extends BaseStack {
  constructor(scope, primer) {
    ...
    if (isLocal) {
      this.adminFacilitiesConstruct = new AdminFacilitiesConstruct(this, this.getConstructId('adminFacilitiesConstruct'), facilitiesProps);
    } else {
      this.facilitiesNestedStack = new FacilitiesNestedStack(this, this.getConstructId('facilitiesNestedStack'), facilitiesProps);
      this.adminFacilitiesConstruct = this.facilitiesNestedStack.adminFacilitiesConstruct;
    }
    ...
    if (isLocal) {
      this.adminProductsConstruct = new AdminProductsConstruct(this, this.getConstructId('adminProductsConstruct'), productsProps);
    } else {
      this.productsNestedStack = new ProductsNestedStack(this, this.getConstructId('productsNestedStack'), productsProps);
      this.adminProductsConstruct = this.productsNestedStack.adminProductsConstruct;
    }
