...
/**
 * NestedStack for Public inventory Pool API endpoints
 *
 ...
 */
class PublicInventoryPoolsNestedStack extends NestedStack {
  get stackId() {
  ...
  constructor(scope, id, props) {
    ...
    this.publicInventoryPoolsConstruct = new PublicInventoryPoolsConstruct(this, 'PublicProductDates', {
...
module.exports = { PublicInventoryPoolsNestedStack };
