...
/**
 * NestedStack for Public Feature Flags API endpoints
 *
 * The API Gateway is now passed by ID from the parent stack,
 * avoiding cross-stack CDK object references.
 */
class PublicFeatureFlagsNestedStack extends NestedStack {
  get stackId() {
  ...
  constructor(scope, id, props) {
    ...
    this.publicFeatureFlagsConstruct = new PublicFeatureFlagsConstruct(this, 'PublicFeatureFlags', {
...
module.exports = { PublicFeatureFlagsNestedStack };
