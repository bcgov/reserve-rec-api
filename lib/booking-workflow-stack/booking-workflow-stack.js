...
class BookingWorkflowStack extends BaseStack {
  constructor(scope, primer) {
    ...
    this.bookingCancellationSubscriber = new lambda.Function(this, 'BookingCancellationSubscriber', {
      functionName: `${this.getAppName()}-${this.getDeploymentName()}-BookingCancellationSubscriber`,
      code: lambda.Code.fromAsset('lib/handlers/bookingCancellationSubscriber'),
    ...
    this.refundSubscriber = new lambda.Function(this, 'RefundSubscriber', {
      functionName: `${this.getAppName()}-${this.getDeploymentName()}-RefundSubscriber`,
      code: lambda.Code.fromAsset('lib/handlers/refundSubscriber'),
      handler: 'index.handler',
      runtime: lambda.Runtime.NODEJS_20_X,
      environment: {
        LOG_LEVEL: this.getConfigValue('logLevel'),
    ...
    this.worldlineProcessor = new lambda.Function(this, 'WorldlineProcessor', {
      functionName: `${this.getAppName()}-${this.getDeploymentName()}-WorldlineProcessor`,
      code: lambda.Code.fromAsset('lib/handlers/worldlineProcessor'),
      handler: 'index.handler',
      runtime: lambda.Runtime.NODEJS_20_X,
      timeout: Duration.seconds(60),
      environment: {
