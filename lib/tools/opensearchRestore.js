 ...
 * Ensure you have the correct values for OPENSEARCH_DOMAIN_URL and OPENSEARCH_MAIN_INDEX in your .env file.
...
const OPENSEARCH_DOMAIN_URL = process.env.OPENSEARCH_DOMAIN_URL || 'http://opensearch.dynamodb.ds:9200';
