...
function cognitoPublicSetup(scope, accountId, props) {
    ...
    new cognito.UserPoolDomain(scope, 'PublicUserPoolDomain', {
        cognitoDomain: {
    ...
    new cdk.CfnOutput(scope, 'PublicUserPoolDomain', {
        value: publicUserPool.userPoolDomainUrl,
        description: 'Public User Pool Domain Reference',
        exportName: 'PublicUserPoolDomain',
    });
