...
function cognitoPublicSetup(scope, props) {
    ...
    new cognito.CfnUserPoolUICustomizationAttachment(scope, 'PublicCognitoUICustomization', {
      ...
      // Outputs
    new cdk.CfnOutput(scope, `PublicUserPoolId-${props.env.ENVIRONMENT}`, {
        value: publicUserPool.userPoolId,
        description: 'Public User Pool Id Reference',
        exportName: `PublicUserPoolId-${props.env.ENVIRONMENT}`,
    });

    new cdk.CfnOutput(scope, `PublicUserPoolClientId-${props.env.ENVIRONMENT}`, {
        value: publicUserPoolClient.userPoolClientId,
        description: 'Public User Pool Client Id Reference',
        exportName: `PublicUserPoolClientId-${props.env.ENVIRONMENT}`,
    });

    new cdk.CfnOutput(scope, `PublicIdentityPoolId-${props.env.ENVIRONMENT}`, {
        value: identityPool.ref,
        description: 'Public Identity Pool Id Reference',
        exportName: `PublicIdentityPoolId-${props.env.ENVIRONMENT}`,
    });

    new cdk.CfnOutput(scope, `PublicUserPoolDomainUrl-${props.env.ENVIRONMENT}`, {
        ...
        exportName: `PublicUserPoolDomainUrl-${props.env.ENVIRONMENT}`,
    });
