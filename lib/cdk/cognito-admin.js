...
function cognitoAdminSetup(scope, props) {
  ...
  // Outputs
  new cdk.CfnOutput(scope, `AdminUserPoolId-${props.env.ENVIRONMENT}`, {
    value: userPool.userPoolId,
    description: 'Admin User Pool Id Reference',
    exportName: `AdminUserPoolId-${props.env.ENVIRONMENT}`,
  });

  new cdk.CfnOutput(scope, `AdminUserPoolClientId-${props.env.ENVIRONMENT}`, {
    value: userPoolClient.userPoolClientId,
    description: 'Admin User Pool Client Id Reference',
    exportName: `AdminUserPoolClientId-${props.env.ENVIRONMENT}`,
  });

  new cdk.CfnOutput(scope, `AdminIdentityPoolId-${props.env.ENVIRONMENT}`, {
    value: identityPool.ref,
    description: 'Admin Identity Pool Id Reference',
    exportName: `AdminIdentityPoolId-${props.env.ENVIRONMENT}`,
  });

  new cdk.CfnOutput(scope, `AdminUserPoolDomainUrl-${props.env.ENVIRONMENT}`, {
    ...
    exportName: `AdminUserPoolDomainUrl-${props.env.ENVIRONMENT}`,
  });
