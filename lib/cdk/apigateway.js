...
function apigwSetup(scope, props) {
  ...
  console.log('api.restApiRootResourceId:', api.restApiRootResourceId);

  new cdk.CfnOutput(scope, 'ReserveRecApiOriginId', {
    value: api.restApiRootResourceId,
    description: 'Reserve Rec API Origin Id Reference',
    exportName: 'ReserveRecApiOriginId',
  })
