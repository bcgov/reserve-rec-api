...
function apigwSetup(scope, props) {
  ...
  new cdk.CfnOutput(scope, 'ReserveRecApiUrl', {
    value: `https://${api.restApiId}.execute-api.${scope.region}.amazonaws.com/${props.env.API_STAGE}/`,
    description: 'Reserve Rec API URL',
    exportName: 'ReserveRecApiUrl',
  })
