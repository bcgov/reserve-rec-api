...
function opensearchSetup(scope, props) {
  ...
  // Outputs
  new CfnOutput(scope, `OpenSearchDomainEndpoint-${props.env.ENVIRONMENT}`, {
    value: opensearchDomain.domainEndpoint,
    description: 'OpenSearch Domain Endpoint',
    exportName: `OpenSearchDomainEndpoint-${props.env.ENVIRONMENT}`,
  });

  new CfnOutput(scope, `OpenSearchDomainArn-${props.env.ENVIRONMENT}`, {
    value: opensearchDomain.domainArn,
    description: 'OpenSearch Domain ARN',
    exportName: `OpenSearchDomainArn-${props.env.ENVIRONMENT}`,
  });
