...
new ReserveRecCdkStack(app, process.env.STACK_NAME, {
  env: {
    ...
    OPENSEARCH_MAIN_INDEX: process.env.OPENSEARCH_MAIN_INDEX || 'main-index',
    OPENSEARCH_BOOKING_INDEX: process.env.BOOKING_INDEX || 'booking-index',
    bookingIndex: process.env.BOOKING_INDEX || 'booking-index',
